...
Const DDD_B3D_TEXS : Int = $53584554
Const DDD_B3D_BRUS : Int = $53555242
Const DDD_B3D_NODE : Int = $45444F4E
Const DDD_B3D_VRTS : Int = $53545256
Const DDD_B3D_TRIS : Int = $53495254
Const DDD_B3D_MESH : Int = $4853454D

' Texture-Flags
Const DDD_B3D_COLORMAP  : Int = 1
Const DDD_B3D_ALPHAMAP  : Int = 2
Const DDD_B3D_MASKED    : Int = 4
Const DDD_B3D_MIPMAP    : Int = 8
Const DDD_B3D_CLAMPU    : Int = 16
Const DDD_B3D_CLAMPV    : Int = 32
Const DDD_B3D_SPHEREMAP : Int = 64
Const DDD_B3D_CUBEMAP   : Int = 128
Const DDD_B3D_UVSET1    : Int = 65536

' Texture and Brush Blend-Modes
Const DDD_B3D_NOTEXTURE  : Int = 0
Const DDD_B3D_NOBLEND    : Int = 1
Const DDD_B3D_REPLACE    : Int = 1
Const DDD_B3D_MODULATE   : Int = 2
Const DDD_B3D_ADD        : Int = 3
Const DDD_B3D_DOT3       : Int = 4
Const DDD_B3D_MODULATE2X : Int = 5

' Brush FX-Modes
Const DDD_B3D_NOFX          : Int = 0
Const DDD_B3D_FULLBRIGHT    : Int = 1
Const DDD_B3D_VERTEXCOLOR   : Int = 2
Const DDD_B3D_FLATSHADING   : Int = 4
Const DDD_B3D_DISABLEFOG    : Int = 8
Const DDD_B3D_DISABLECULLBF : Int = 16
...
Type TB3DLoader
	...
	Method ReadTextures()
		...
		While Self.Stream.Pos() < ChunkEndPos
			...
			Texture.SetClamp(ClampU, ClampV)
	...
	Method ReadBrushs()
		...
		While Self.Stream.Pos() < ChunkEndPos
			...
			Select Blend
				...
				Case DDD_B3D_MODULATE
					Material.SetBlendMode(DDD_MATERIAL_MODULATE)

				Case DDD_B3D_ADD
					Material.SetBlendMode(DDD_MATERIAL_ADD)
			End Select
