...
Const DDD_DDSD_CAPS                  : Int = $00000001, ..
      DDD_DDSD_HEIGHT                : Int = $00000002, ..
      DDD_DDSD_WIDTH                 : Int = $00000004, ..
      DDD_DDSD_PITCH                 : Int = $00000008, ..
      DDD_DDSD_PIXELFORMAT           : Int = $00001000, ..
      DDD_DDSD_MIPMAPCOUNT           : Int = $00020000, ..
      DDD_DDSD_LINEARSIZE            : Int = $00080000, ..
      DDD_DDSD_DEPTH                 : Int = $00800000

' DirectDraw Pixel Format
Const DDD_DDPF_ALPHAPIXELS           : Int = $00000001, ..
      DDD_DDPF_FOURCC                : Int = $00000004, ..
      DDD_DDPF_RGB                   : Int = $00000040

' DirectDraw Four Character Code(Compression Methods)
Const DDD_FOURCCC_DXT1               : Int = $31545844, ..
      DDD_FOURCCC_DXT3               : Int = $33545844, ..
      DDD_FOURCCC_DXT5               : Int = $35545844

' DirectDraw Surface Capabilities
Const DDD_DDSCAPS_COMPLEX            : Int = $00000008, ..
      DDD_DDSCAPS_TEXTURE            : Int = $00001000, ..
      DDD_DDSCAPS_MIPMAP             : Int = $00400000

' DirectDraw Surface Capabilities 2
Const DDD_DDSCAPS2_CUBEMAP           : Int = $00000200, ..
      DDD_DDSCAPS2_CUBEMAP_POSITIVEX : Int = $00000400, ..
      DDD_DDSCAPS2_CUBEMAP_NEGATIVEX : Int = $00000800, ..
      DDD_DDSCAPS2_CUBEMAP_POSITIVEY : Int = $00001000, ..
      DDD_DDSCAPS2_CUBEMAP_NEGATIVEY : Int = $00002000, ..
      DDD_DDSCAPS2_CUBEMAP_POSITIVEZ : Int = $00004000, ..
      DDD_DDSCAPS2_CUBEMAP_NEGATIVEZ : Int = $00008000, ..
      DDD_DDSCAPS2_VOLUME            : Int = $00200000

' DDS PixelFormats
Const DDD_DDS_RGBA8888               : Int = 1, .. ' -> GL_RGBA
      DDD_DDS_RGBA5551               : Int = 2, .. ' -> GL_RGBA
      DDD_DDS_RGBA4444               : Int = 3, .. ' -> GL_RGBA
      DDD_DDS_RGB888                 : Int = 4, .. ' -> GL_RGB
      DDD_DDS_RGB565                 : Int = 5, .. ' -> GL_RGB
      DDD_DDS_DXT1                   : Int = 6, .. ' -> GL_COMPRESSED_RGBA_S3TC_DXT1_EXT
      DDD_DDS_DXT3                   : Int = 7, .. ' -> GL_COMPRESSED_RGBA_S3TC_DXT3_EXT
      DDD_DDS_DXT5                   : Int = 8     ' -> GL_COMPRESSED_RGBA_S3TC_DXT5_EXT
